...
namespace CaveatEmptor.Persistence
{
    ...
    public class NHibernateHelper
    {
        ...
        const String DbFile = @"c:\Temp\CaveatEmptor.db.sqlite";
        ...
        public static FluentConfiguration Configuration
        {
            get
            {
                if (configuration == null)
                {
                    lock (LockConfig)
                    {
                        BuildConfiguration(!File.Exists(DbFile)); // new Configuration();
                    }
                }
        ...
        {
            BuildConfiguration(createDb:true);
